    ...
    <div class="login-clean">
        <form method="POST" action="../laboratorioweb/scripts/login.php">
            ...
            <div class="input-group" id="inputs_formulario">
                <div class="input-group-prepend"><span class="input-group-text">Email</span></div><input class="form-control" type="email" id="email" inputmode="email" name="email" required>
                <div class="input-group-append"></div>
            </div>
            <div class="input-group" id="inputs_formulario">
                <div class="input-group-prepend"><span class="input-group-text">Contraseña</span></div><input class="form-control" type="password" name="passwd" required>
                <div class="input-group-append"></div>
            </div>
            <div class="form-group"><button class="btn btn-primary btn-block" id="login_button_login" type="submit">Login</button></div>
        </form>
    </div>
